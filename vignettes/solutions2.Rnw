...
\item Plot the standardised residuals against the fitted values.
<<echo=echo,fig.keep='none'>>=
...
@
\item Examine the Standardised residual plots. Is there anything that would
