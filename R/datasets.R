...
#' The \code{ratfeed2} and \code{ratfeed3} datasets are
...
#'
#' @description This data set contains the number of honey
#' producing bee colonies (Thousands of colonies (USDA))
#' in the US and the Divorce rate in South Carolina
#' (Divorces per 1000 people (US Census)). With a correlation
#' of 0.9, this is clearly a significant result.
#'
#' @source Spurious correlations
#' (http://www.tylervigen.com/view_correlation?id=75)
#' @docType data
#' @examples
#' data(correlation)
...
#' \describe{
#' \item{Lifetime post total impressions}{Impressions are the number of times a post
#'  from a page is displayed, whether the post is clicked or not. People may see multiple
#'   impressions of the same post. For example, someone might see a Page update in News
...
#' \item{Lifetime post impressions by people who have liked a page}{Total number
#'  of impressions just from people who have liked a page.}
#' \item{Lifetime post reach by people who like a page}{The number of people who saw a page post
#'  because they have liked that page (unique users).}
#' \item{Lifetime people who have liked a page and engaged with a post}{The number of people who have liked
#'  a Page and clicked anywhere in a post (Unique users).}
